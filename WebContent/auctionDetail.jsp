...
<!-- main begin-->
  ...
  <div class="top10">
    ...
    <input type="button" value="返回列表" class="spbg buttombg f14" 
    		onclick="location='${pageContext.request.contextPath}/auction/queryAuction'" />
  </div>
  <div class="offer">
    <h3>出价记录</h3>
    ...
    <!-- 迭代输出竞拍记录 -->
    <c:if test="${fn:length(auctionDetail.auctionrecord)>0}">
		<c:forEach var="auctionRecord" items="${auctionDetail.auctionrecord}">
	      	<ul class="rows">
		        <li>
