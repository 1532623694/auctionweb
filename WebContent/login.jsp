...
<meta http-equiv="keywords" content="keyword1,k	qeyword2,keyword3">
						...
						<dl>
							...
							<dd>
								<label class="lf" for="passwords">验证码：</label> <input
									type="text" name="inputCode" class="inputh inputs lf" value=""
									id="passwords" /> <span class="wordp lf"> <img
							...
							<dd class="buttom">
								<input name="" type="submit" value="登 录"
									...
									onclick="javascript:location='${pageContext.request.contextPath}/register.jsp'"
									class="spbg buttombg f14 lf" /> <span class="blues  lf"><a
									href="" title="">忘记密码?</a></span>
								<div class="cl"></div>
							</dd>
